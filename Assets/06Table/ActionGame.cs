...
{
	public List<TableEntity_Tip> ItemData; // Replace 'EntityType' to an actual type that is serializable.
	public List<TableEntity_Item> TipMess; // Replace 'EntityType' to an actual type that is serializable.
